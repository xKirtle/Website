...
<div id="musica"><h7>Anuncio: </h7></div><div id="tocando"><h5><marquee direction="left" scrolldelay="190"><a href="#" onClick="atualiza_dados('musicaver','musica')"><span id="musicaver">Acesse: www.playjogos.net e Jogue outros jogos :D HabboBr o Melhor servidor Habbo Pirata</marquee></span></a></h5></div>
...
<div id="ouvintes"></div><div id="contador"><h1><a href="#" onClick="atualiza_dados('ouvintesver','ouvintes')"><span id="ouvintesver">23</span></a></h1></div>
