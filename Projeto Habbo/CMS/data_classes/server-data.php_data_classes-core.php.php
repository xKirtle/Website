...
$badgesurl = "http://habbi.com.br/game/c_images/album1584/";
...
$users32 = mysql_query("SELECT * FROM server_status");
$on1 = mysql_fetch_assoc($users32);
$UsersOnline = $on1['users_online'];
$data2212 = mysql_fetch_assoc(mysql_query("SELECT * FROM users WHERE username='" . $_SESSION['username'] . "' LIMIT 1"));
